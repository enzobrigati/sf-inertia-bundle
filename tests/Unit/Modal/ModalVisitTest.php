...
class ModalVisitTest extends TestCase
{
    ...
    public function it_can_set_the_http_method(string $method): void
    {
    ...
    #[Test]
    public function it_can_configure_navigation(): void
    {
    ...
    #[Test]
    public function it_can_set_the_data(): void
    {
        $data = ['key' => 'value'];
    ...
    #[Test]
    public function it_sets_the_data_to_null_when_empty(): void
    {
    ...
    #[Test]
    public function it_sets_the_headers_to_null_when_empty(): void
    {
    ...
    #[Test]
    public function it_can_set_a_modal_config(): void
    {
    ...
    #[Test]
    public function it_can_set_a_modal_config_from_a_callable(): void
    {
    ...
    #[Test]
    public function it_can_set_a_query_string_array_format(): void
    {
