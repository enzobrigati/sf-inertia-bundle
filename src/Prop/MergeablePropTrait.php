...
/**
 * @phpstan-require-implements MergeablePropInterface
 */
trait MergeablePropTrait
{
    /**
     ...
     */
    public function append(bool|string|array $path = true, string|null $matchOn = null): static
    {
        match (true) {
     ...
     * @param bool|string|array<array-key, string> $path
     */
    public function prepend(bool|string|array $path = true, string|null $matchOn = null): static
    {
        match (true) {
            is_bool($path) => $this->append = ! $path,
